...
public class VoiceFragment_Inner4 extends Fragment implements View.OnClickListener, VoiceAdapter.OnItemClickListener {
    ...
    public static VoiceFragment_Inner4 newInstance(String param1, String param2) {
        VoiceFragment_Inner4 fragment = new VoiceFragment_Inner4();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_voice_inner_4, container, false);
    ...
    private void initView() {
        for (int i = 0; i <10; i++) {
            ...
            bean.content = "VoiceFragment_Inner_Four"+i;
            mVoiceList.add(bean);
        }
    ...
    public void onItemClick(int position) {
        ...
        fragmentCacheManager.addFragment(VoiceFragment_Inner5.class,null);
    }
}