...
public class VoiceFragment_Inner3 extends Fragment implements View.OnClickListener, VoiceAdapter.OnItemClickListener {
    ...
    public static VoiceFragment_Inner3 newInstance(String param1, String param2) {
        VoiceFragment_Inner3 fragment = new VoiceFragment_Inner3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_voice_inner_3, container, false);
    ...
    private void initView() {
        for (int i = 0; i <10; i++) {
            ...
            bean.content = "VoiceFragment_Inner_Three"+i;
            mVoiceList.add(bean);
        }
    ...
    public void onItemClick(int position) {
        ...
        fragmentCacheManager.addInnerFragment(VoiceFragment_Inner4.class,null);
    }
}