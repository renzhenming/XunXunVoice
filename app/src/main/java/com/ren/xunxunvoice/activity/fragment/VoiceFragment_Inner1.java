...
public class VoiceFragment_Inner1 extends Fragment implements View.OnClickListener, VoiceAdapter.OnItemClickListener {
    ...
    public static VoiceFragment_Inner1 newInstance(String param1, String param2) {
        VoiceFragment_Inner1 fragment = new VoiceFragment_Inner1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_voice_inner_1, container, false);
    ...
    private void initView() {
        for (int i = 0; i <10; i++) {
            ...
            bean.content = "VoiceFragment_Inner_One"+i;
            mVoiceList.add(bean);
        }
    ...
    public void onItemClick(int position) {
        ...
        fragmentCacheManager.addInnerFragment(VoiceFragment_Inner2.class,null);
    }
}